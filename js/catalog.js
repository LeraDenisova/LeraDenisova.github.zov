...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (filterOpen) filterOpen.addEventListener("click", Filter);
  if (filterEnd) filterEnd.addEventListener("click", Filter);
});
